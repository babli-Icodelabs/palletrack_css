...
import EditListingMaterialDescriptionForm from './EditListingMaterialDescriptionForm';
 ...
 * @returns {JSX.Element}
 */
const EditListingMaterialDescriptionPanel = props => {
  const {
    className,
    rootClassName,
    listing,
  ...
  return (
    <main className={classes}>
      ...
      {canShowEditListingDetailsForm ? (
        <EditListingMaterialDescriptionForm
          className={css.form}
...
export default EditListingMaterialDescriptionPanel;
